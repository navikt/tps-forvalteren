...
CREATE TABLE T_SKD_ENDRINGSMELDING (
  SKD_ENDRINGSMELDING_ID        NUMBER(9)      NOT NULL,
  SKD_ENDRINGSMELDING_GRUPPE_ID NUMBER(9)      NOT NULL,
...
ALTER TABLE T_SKD_ENDRINGSMELDING
  ADD CONSTRAINT T_SKD_ENDRINGSMELDING_PK PRIMARY KEY (SKD_ENDRINGSMELDING_ID);
...
-- S E Q U E N C E S --
-----------------------
CREATE SEQUENCE T_SKD_MELDINGSGRUPPE_SEQ
  START WITH 100000000;
CREATE SEQUENCE T_SKD_ENDRINGSMELDING_SEQ
  START WITH 100000000;
CREATE SEQUENCE T_SKD_ENDRINGSMELDING_LOGG_SEQ
  START WITH 100000000;

----------------------------
-- A L T E R  L E N G T H --
----------------------------
ALTER TABLE T_GATEADRESSE
  MODIFY HUSNUMMER VARCHAR2(5);