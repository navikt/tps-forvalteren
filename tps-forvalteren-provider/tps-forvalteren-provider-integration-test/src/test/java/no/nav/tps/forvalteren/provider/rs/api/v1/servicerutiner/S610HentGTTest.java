...
//        diskresjonskodeConsumer.getDiskresjonskodeResponse(fnr).getDiskresjonskode();

//        HentDiskresjonskodeResponse diskresjonskodeResponse = new HentDiskresjonskodeResponse();
//        diskresjonskodeResponse.setDiskresjonskode("");
//        doReturn(diskresjonskodeResponse).when(diskresjonskodeConsumerMock).getDiskresjonskodeResponse(anyString());
