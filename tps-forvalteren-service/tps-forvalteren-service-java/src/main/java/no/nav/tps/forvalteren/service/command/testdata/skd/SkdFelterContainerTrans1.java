...
import static no.nav.tps.forvalteren.domain.service.tps.config.SkdConstants.AARSAK_KO_DE;
...
import static no.nav.tps.forvalteren.domain.service.tps.config.SkdConstants.PERSON_KO_DE;
...
import static no.nav.tps.forvalteren.domain.service.tps.config.SkdConstants.STATSBORGERSKAP_REGDATO;
import static no.nav.tps.forvalteren.domain.service.tps.config.SkdConstants.STATUS_KO_DE;
import static no.nav.tps.forvalteren.domain.service.tps.config.SkdConstants.TILDELING_KO_DE;
...
import static no.nav.tps.forvalteren.service.command.testdata.skd.impl.WhitespaceConstants.WHITESPACE_100_STK;
import static no.nav.tps.forvalteren.service.command.testdata.skd.impl.WhitespaceConstants.WHITESPACE_25_STK;
...
import static no.nav.tps.forvalteren.service.command.testdata.skd.impl.WhitespaceConstants.WHITESPACE_5_STK;
...
public class SkdFelterContainerTrans1 implements SkdFelterContainer {
    ...
    private void leggTilSkdFeltDefinisjonerDel1(ArrayList<SkdFeltDefinisjon> skdFelter) {
        ...
        skdFelter.add(new SkdFeltDefinisjon(FODSELSDATO, SIX_OES, 1, 6, 1, 6));
        skdFelter.add(new SkdFeltDefinisjon(PERSONNUMMER, FIVE_OES, 2, 5, 7, 11));
        skdFelter.add(new SkdFeltDefinisjon(MASKINDATO, DUMMY_DATO, 3, 8, 12, 19));
        skdFelter.add(new SkdFeltDefinisjon(MASKINTID, SIX_OES, 4, 6, 20, 25));
        skdFelter.add(new SkdFeltDefinisjon(TRANSTYPE, "0", 5, 1, 26, 26));
        skdFelter.add(new SkdFeltDefinisjon(AARSAK_KO_DE, "00", 6, 2, 27, 28));
        skdFelter.add(new SkdFeltDefinisjon(REG_DATO, DUMMY_DATO, 7, 8, 29, 36));
        skdFelter.add(new SkdFeltDefinisjon(STATUS_KO_DE, " ", 8, 1, 37, 37));
        skdFelter.add(new SkdFeltDefinisjon(DOEDSDATO, DUMMY_DATO, 9, 8, 38, 45));
        ...
        skdFelter.add(new SkdFeltDefinisjon(STATSBORGERSKAP_REGDATO, DUMMY_DATO, 19, 8, 306, 313));
        skdFelter.add(new SkdFeltDefinisjon("familienummer", DUMMY_IDENT, 20, 11, 314, 324));
        skdFelter.add(new SkdFeltDefinisjon(REG_DATO_FAM_NR, DUMMY_DATO, 21, 8, 325, 332));
        skdFelter.add(new SkdFeltDefinisjon(PERSON_KO_DE, "0", 22, 1, 333, 333));
        skdFelter.add(new SkdFeltDefinisjon("spesRegType", "0", 23, 1, 334, 334));
        skdFelter.add(new SkdFeltDefinisjon("datoSpesRegType", DUMMY_DATO, 24, 8, 335, 342));
        skdFelter.add(new SkdFeltDefinisjon(SIVILSTAND, "0", 25, 1, 343, 343));
        skdFelter.add(new SkdFeltDefinisjon(REGDATO_SIVILSTAND, DUMMY_DATO, 26, 8, 344, 351));
    }

    private void leggTilSkdFeltDefinisjonerDel2(ArrayList<SkdFeltDefinisjon> skdFelter) {
        skdFelter.add(new SkdFeltDefinisjon(EKTEFELLE_PARTNER_FODSELSDATO, SIX_OES, 28, 6, 352, 357));
        skdFelter.add(new SkdFeltDefinisjon(EKTEFELLE_PARTNER_PERSONNUMMMER, FIVE_OES, 29, 5, 358, 362));
        ...
        skdFelter.add(new SkdFeltDefinisjon(REG_DATO_ADR, DUMMY_DATO, 33, 8, 416, 423));
        skdFelter.add(new SkdFeltDefinisjon(FLYTTEDATO_ADR, DUMMY_DATO, 34, 8, 424, 431));
        skdFelter.add(new SkdFeltDefinisjon("kommunenummer", "0000", 35, 4, 432, 435));
        skdFelter.add(new SkdFeltDefinisjon("gateGaard", FIVE_OES, 36, 5, 436, 440));
        ...
        skdFelter.add(new SkdFeltDefinisjon(FRA_LAND_REGDATO, DUMMY_DATO, 51, 8, 607, 614));
        skdFelter.add(new SkdFeltDefinisjon(FRA_LAND_FLYTTEDATO, DUMMY_DATO, 52, 8, 615, 622));
        skdFelter.add(new SkdFeltDefinisjon("fraKommune", "0000", 53, 4, 623, 626));
        skdFelter.add(new SkdFeltDefinisjon("fraKommRegdato", DUMMY_DATO, 54, 8, 627, 634));
        skdFelter.add(new SkdFeltDefinisjon("fraKommFlyttedato", DUMMY_DATO, 55, 8, 635, 642));
        skdFelter.add(new SkdFeltDefinisjon("utvandretTilLand", "000", 56, 3, 643, 645));
        skdFelter.add(new SkdFeltDefinisjon("tilLandRegdato", DUMMY_DATO, 57, 8, 646, 653));
        skdFelter.add(new SkdFeltDefinisjon("tilLandFlyttedato", DUMMY_DATO, 58, 8, 654, 661));
        skdFelter.add(new SkdFeltDefinisjon("samemanntall", " ", 59, 1, 662, 662));
        skdFelter.add(new SkdFeltDefinisjon("datoSamemanntall", DUMMY_DATO, 60, 8, 663, 670));
        skdFelter.add(new SkdFeltDefinisjon("umyndiggjort", " ", 61, 1, 671, 671));
        skdFelter.add(new SkdFeltDefinisjon("datoUmyndiggjort", DUMMY_DATO, 62, 8, 672, 679));
        skdFelter.add(new SkdFeltDefinisjon(FORELDREANSVAR, " ", 63, 1, 680, 680));
        skdFelter.add(new SkdFeltDefinisjon(DATO_FORELDREANSVAR, DUMMY_DATO, 64, 8, 681, 688));
        skdFelter.add(new SkdFeltDefinisjon("arbeidstillatelse", " ", 65, 1, 689, 689));
        skdFelter.add(new SkdFeltDefinisjon("datoArbeidstillatelse", DUMMY_DATO, 66, 8, 690, 697));
        skdFelter.add(new SkdFeltDefinisjon("fremkonnummer", DUMMY_DATO, 67, 8, 698, 705));
    }

    private void leggTilSkdFeltDefinisjonerDel3(ArrayList<SkdFeltDefinisjon> skdFelter) {

        skdFelter.add(new SkdFeltDefinisjon("morsFodselsdato", SIX_OES, 69, 6, 706, 711));
        skdFelter.add(new SkdFeltDefinisjon("morsPersonnummer", FIVE_OES, 70, 5, 712, 716));
        ...
        skdFelter.add(new SkdFeltDefinisjon("nyttFnr", DUMMY_IDENT, 80, 11, 853, 863));
        ...
        skdFelter.add(new SkdFeltDefinisjon("vigselsdato", DUMMY_DATO, 103, 8, 903, 910));
        skdFelter.add(new SkdFeltDefinisjon("medlKirken", " ", 104, 1, 911, 911));
        skdFelter.add(new SkdFeltDefinisjon("sekvensnr", SIX_OES, 105, 6, 912, 917));
        skdFelter.add(new SkdFeltDefinisjon("bolignr", WHITESPACE_5_STK, 106, 5, 918, 922));
    ...
    private void leggTilSkdFeltDefinisjonerDel4(ArrayList<SkdFeltDefinisjon> skdFelter) {
        ...
        skdFelter.add(new SkdFeltDefinisjon("dnrHjemlandRegDato", DUMMY_DATO, 115, 8, 1074, 1081));
        skdFelter.add(new SkdFeltDefinisjon("dnrIdKontroll", " ", 116, 1, 1082, 1082));
        skdFelter.add(new SkdFeltDefinisjon("postadrRegDato", DUMMY_DATO, 117, 8, 1083, 1090));
        ...
        skdFelter.add(new SkdFeltDefinisjon("regdatoStatsb2", DUMMY_DATO, 121, 8, 1099, 1106));
        skdFelter.add(new SkdFeltDefinisjon("statsborgerskap3", "000", 122, 3, 1107, 1109));
        skdFelter.add(new SkdFeltDefinisjon("regdatoStatsb3", DUMMY_DATO, 123, 8, 1110, 1117));
        skdFelter.add(new SkdFeltDefinisjon("statsborgerskap4", "000", 124, 3, 1118, 1120));
        skdFelter.add(new SkdFeltDefinisjon("regdatoStatsb4", DUMMY_DATO, 125, 8, 1121, 1128));
        skdFelter.add(new SkdFeltDefinisjon("statsborgerskap5", "000", 126, 3, 1129, 1131));
        skdFelter.add(new SkdFeltDefinisjon("regdatoStatsb5", DUMMY_DATO, 127, 8, 1132, 1139));
        skdFelter.add(new SkdFeltDefinisjon("statsborgerskap6", "000", 128, 3, 1140, 1142));
        skdFelter.add(new SkdFeltDefinisjon("regdatoStatsb6", DUMMY_DATO, 129, 8, 1143, 1150));
        skdFelter.add(new SkdFeltDefinisjon("statsborgerskap7", "000", 130, 3, 1151, 1153));
        skdFelter.add(new SkdFeltDefinisjon("regdatoStatsb7", DUMMY_DATO, 131, 8, 1154, 1161));
        skdFelter.add(new SkdFeltDefinisjon("statsborgerskap8", "000", 132, 3, 1162, 1164));
        skdFelter.add(new SkdFeltDefinisjon("regdatoStatsb8", DUMMY_DATO, 132, 8, 1165, 1172));
        skdFelter.add(new SkdFeltDefinisjon("statsborgerskap9", "000", 133, 3, 1173, 1175));
        skdFelter.add(new SkdFeltDefinisjon("regdatoStatsb9", DUMMY_DATO, 134, 8, 1176, 1183));
        skdFelter.add(new SkdFeltDefinisjon("statsborgerskap10", "000", 135, 3, 1184, 1186));
        skdFelter.add(new SkdFeltDefinisjon("regdatoStatsb10", DUMMY_DATO, 136, 8, 1187, 1194));
        skdFelter.add(new SkdFeltDefinisjon("bibehold", " ", 137, 1, 1195, 1195));
        skdFelter.add(new SkdFeltDefinisjon("regdatoBibehold", DUMMY_DATO, 138, 8, 1196, 1203));
        ...
        skdFelter.add(new SkdFeltDefinisjon("vergeFnr", DUMMY_IDENT, 144, 11, 1233, 1243));
