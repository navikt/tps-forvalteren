...
public enum UserRole implements GrantedAuthority {
    ...
    ROLE_ACCESS("0000-GA-TPSF-LES", "0000-GA-TPSF-SKRIV", "0000-GA-TPSF-SKDMELDING","0000-GA-TPSF-SERVICERUTINER", "0000-GA-TPSF-UTVIKLER"),
    ...
    ROLE_TPSF_UTVIKLER("0000-GA-TPSF-UTVIKLER"),
