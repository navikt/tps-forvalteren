...
public class OpprettTestdataPersonerTest {
    ...
    private HashSet<String> dummyTilgjengeligeFiktiveIdenterSet = new HashSet<>();
    ...
    public void manOppretterLikeMangePersonerSomManSpoerOmHvisAltGaarGreit() throws Exception {
        ...
        dummyTilgjengeligeFiktiveIdenterSet.add(dummyId1);
        dummyFiktiveIdenterFraGenerator2.add(dummyId2);
        dummyTilgjengeligeFiktiveIdenterSet.add(dummyId2);
        ...
        when(filterPaaIdenterTilgjengeligeIMiljoMock.filtrer(any(Set.class))).thenReturn(dummyTilgjengeligeFiktiveIdenterSet, dummyTilgjengeligeFiktiveIdenter2);
        when(findIdenterNotUsedInDB.filtrer(any(Set.class))).thenReturn(dummyTilgjengeligeFiktiveIdenterSet, dummyFiktiveIdenterFraGenerator2);
    ...
    public void hvisEtNummerIkkeErTilgjengeligSaaBlirDetTattBortOgIkkeBruktTilAaOpprettePerson() throws Exception {
        ...
        when(filterPaaIdenterTilgjengeligeIMiljoMock.filtrer(any(Set.class))).thenReturn(dummyTilgjengeligeFiktiveIdenterSet);
        when(findIdenterNotUsedInDB.filtrer(any(Set.class))).thenReturn(dummyTilgjengeligeFiktiveIdenterSet, dummyFiktiveIdenterFraGenerator2);
    ...
    public void hvisManIkkeFinnerNokTilgjengeligeIdenterFoersteForsoekSaaSpoerManIgjenTilManFaarNokNummer() throws Exception {
        ...
        when(filterPaaIdenterTilgjengeligeIMiljoMock.filtrer(any(Set.class))).thenReturn(dummyTilgjengeligeFiktiveIdenterSet);
        when(findIdenterNotUsedInDB.filtrer(any())).thenReturn(dummyTilgjengeligeFiktiveIdenterSet);
