package no.nav.tps.vedlikehold.provider.rs.api.v1.serviceroutines;

import no.nav.tps.vedlikehold.provider.rs.api.v1.AbstractServiceControllerIntegrationTest;
