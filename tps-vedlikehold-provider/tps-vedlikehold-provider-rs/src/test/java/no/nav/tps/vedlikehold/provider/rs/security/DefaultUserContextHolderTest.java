...
public class DefaultUserContextHolderTest {
    ...
    private static final List<? extends GrantedAuthority> ROLES = Arrays.asList(UserRole.ROLE_READ_Q, UserRole.ROLE_WRITE_Q);
    ...
    public void getRolesReturnsRolesFromAuthentication() {
        ...
        assertThat(userContextHolder.getRoles(), containsInAnyOrder((GrantedAuthority)UserRole.ROLE_READ_Q, (GrantedAuthority) UserRole.ROLE_WRITE_Q));
    }
